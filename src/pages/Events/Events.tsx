...
const Events = () => {
  ...
  <div className="absolute left-[48px] top-[48px] z-10">
    <p className="font-display font-black text-[#f2eae0] text-[clamp(3.5rem,3.6rem,3.6rem)] tracking-[-4px] leading-none">
      UPCOMING
    </p>

    <h1 className="font-display font-black text-[#f2eae0] text-[clamp(3.5rem,8.4rem,12rem)] tracking-[-10px] leading-[0.9] -mt-2">
      EVENTS
    </h1>
  </div>
